...
public class NoteProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.zqg.memo.provider";
    ...
    public String getType(@NonNull Uri uri) {
        switch (uriMatcher.match(uri)) {
            case NOTE_DIR:
                return "vnd.android.cursor.dir/vnd.com.zqg.memo.provider.note";
            case NOTE_ITEM:
                return "vnd.android.cursor.item/vnd.com.zqg.memo.provider.note";
            case TABS_DIR:
                return "vnd.android.cursor.dir/vnd.com.zqg.memo.provider.tabs";
            case TABS_ITEM:
                return "vnd.android.cursor.item/vnd.com.zqg.memo.provider.tabs";
        }
        return null;
    }
