...
public class MainActivity extends AppCompatActivity {
    ...
    private void dialogMoreChoice() {
        ...
        builder.setTitle("分组删除");
        builder.setIcon(R.drawable.delete_group);
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            try {
                if (selected.length!=0){
                    Uri uri = Uri.parse("content://com.zqg.memo.provider/note");
                    Uri uriTabs = Uri.parse("content://com.zqg.memo.provider/tabs");
                    int mNum = 0;
    ...
    private void addTabToDataBase(int position, String tabName) {
        Uri uri = Uri.parse("content://com.zqg.memo.provider/tabs");
        ContentValues values = new ContentValues();
